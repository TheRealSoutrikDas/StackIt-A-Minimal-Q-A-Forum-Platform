						...
						<div>
							...
							<div className="mt-1 relative">
								...
								<Input
									...
									className={`w-68 pl-12 placeholder-gray-400 sm:text-sm ${
										errors.email
											? "border-red-300"
											: "border-gray-300"
									}`}
						...
						<div>
							...
							<div className="mt-1 relative">
								...
								<Input
									...
									className={`block w-68 pl-12 placeholder-gray-400 sm:text-sm ${
										errors.password
											? "border-red-300"
											: "border-gray-300"
									}`}
								...
								<div className="absolute inset-y-0 right-0 pr-10 flex items-center">
									<button
										...
										className="border-none text-gray-400 bg-transparent hover:text-gray-800 cursor-pointer"
									>
										{showPassword ? (
