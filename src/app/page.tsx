...
const mockQuestions: Question[] = [
  {
    ...
    description: 'I\'m building a web application using Next.js and TypeScript, and I need to implement user authentication. What are the best practices for handling authentication in this stack? I\'ve heard about NextAuth.js but I\'m not sure if it\'s the right choice for my use case.',
    author: mockUser,
  ...
  },
  {
    ...
    description: 'I\'m new to Tailwind CSS and want to learn the best practices for creating responsive designs. What are some common patterns and approaches you use when building responsive layouts?',
    author: mockUser,
  ...
  },
  {
    ...
    description: 'I want to start a new project with React and TypeScript. What tools and configurations do you recommend for the development environment? Should I use Create React App or Vite?',
    author: mockUser,
...
export default function HomePage() {
  ...
  const handleAskQuestion = (data: { title: string; description: string; tags: Tag[] }) => {
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="bg-blue-600 text-white px-6 py-3 rounded-md text-sm font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
              >
                Ask Question
              </button>
            </div>
